...
export default function App() {
  return (
    ...
    <div className="flex min-h-screen flex-col bg-slate-100 pt-[env(safe-area-inset-top)]">
      <UniversalAppsNavBar
        product="compress"
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className={`${CONTAINER} flex flex-row items-center gap-3 py-4 text-xs text-slate-500 sm:gap-4`}>
          <span>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-slate-700 underline-offset-2 hover:text-orange-700 hover:underline"
            >
              UNI SIM
            </a>
          </span>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="Universal Compress on GitHub"
            title="View source on GitHub"
            className="ml-auto inline-flex shrink-0 items-center gap-1.5 text-slate-600 transition-colors hover:text-slate-900"
          >
